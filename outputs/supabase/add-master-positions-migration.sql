-- ============================================================
-- Migration: Add master_positions table to Master Data system
-- Run this script in the Supabase SQL Editor
-- ============================================================

-- Step 1: Create master_positions table
...
DROP POLICY IF EXISTS "master_positions_authenticated_select" ON public.master_positions;
DROP POLICY IF EXISTS "master_positions_authenticated_insert" ON public.master_positions;
DROP POLICY IF EXISTS "master_positions_authenticated_update" ON public.master_positions;
DROP POLICY IF EXISTS "master_positions_authenticated_delete" ON public.master_positions;
CREATE POLICY "master_positions_authenticated_select" ON public.master_positions FOR SELECT TO authenticated USING (true);
CREATE POLICY "master_positions_authenticated_insert" ON public.master_positions FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY "master_positions_authenticated_update" ON public.master_positions FOR UPDATE TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "master_positions_authenticated_delete" ON public.master_positions FOR DELETE TO authenticated USING (true);


-- Step 2: Redefine the get_database function to include master_positions
...
-- Step 3: Redefine the replace_database function to clear and insert master_positions
...
BEGIN
  ...
  TRUNCATE TABLE public.login_history, public.notifications, public.checkout_records, 
                 ...
                 public.asset_control_metadata, public.app_users RESTART IDENTITY CASCADE;
