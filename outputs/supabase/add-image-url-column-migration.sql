-- ============================================================
-- Migration: Add image_url column to assets tables & update RPCs
-- Run this script in the Supabase SQL Editor
-- ============================================================

-- Step 1: Add image_url column to asset tables
...
-- Step 2: Redefine the get_database function to return the image_url column as imageUrl
...
-- Step 3: Redefine the replace_database function to map and save imageUrl into image_url column
