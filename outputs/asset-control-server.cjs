...
const csvSchemas = {
  ...
  computerAssets: ["assetCode", "rustDeskId", "company", "type", "brand", "model", "serial", "user", "department", "location", "room", "purchaseDate", "status", "warrantyExpirationDate", "windowsVersion", "sentForRepairDate", "adapter", "mouse", "laptopBag", "syncOneDrive", "remark", "imageUrl", "updatedAt"],
  otherAssets: ["assetCode", "company", "type", "brand", "model", "serial", "location", "room", "purchaseDate", "status", "warrantyExpirationDate", "remark", "imageUrl", "updatedAt"],
